...
class TestExceptions:
    ...
    def test_element_not_interactable_exception(self, driver):
        ...
        assert exceptions_page.get_confirmation_message() == "Row 2 was saved", "Confirmation is not expected"
    ...
    def test_invalid_element_state_exception(self, driver):
        ...
        assert exceptions_page.get_confirmation_message() == "Row 1 was saved", "Confirmation is not expected"
    ...
    def test_stale_element_reference_exception(self, driver):
        ...
        exceptions_page.open()
        exceptions_page.add_second_row()
        assert not exceptions_page.are_instructions_displayed(), "Instruction should text element not be displayed"
